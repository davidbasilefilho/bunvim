 ...
 */
export const positionIsBefore = (a: Position, b: Position): boolean =>
	positionCompare(a, b) < 0;

/**
 * Check if position a is after position b.
 */
export const positionIsAfter = (a: Position, b: Position): boolean =>
	positionCompare(a, b) > 0;
 ...
 */
export const rangeIsEmpty = (r: Range): boolean =>
	positionEquals(r.start, r.end);
