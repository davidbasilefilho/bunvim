...
export function registerDefaultKeymaps() {
  registerKeymap({
    ...
    rhs: () => {
      ...
      if (win) windowActions.setCursor(win.id, win.cursor.line, Math.max(0, win.cursor.column - 1));
    },
  });
  ...
  registerKeymap({
    ...
    rhs: () => {
      const win = windowActions.getActive();
      if (win) windowActions.setCursor(win.id, win.cursor.line + 1, win.cursor.column);
    },
  });
  ...
  registerKeymap({
    ...
    rhs: () => {
      const win = windowActions.getActive();
      if (win) windowActions.setCursor(win.id, Math.max(0, win.cursor.line - 1), win.cursor.column);
    },
  });
  ...
  registerKeymap({
    ...
    rhs: () => {
      const win = windowActions.getActive();
      if (win) windowActions.setCursor(win.id, win.cursor.line, win.cursor.column + 1);
    },
  });
