...
export const setOption = <K extends keyof VimOptions>(key: K, value: VimOptions[K]): void => {
  currentOptions = { ...currentOptions, [key]: value };
};

export const getOption = <K extends keyof VimOptions>(key: K): VimOptions[K] => currentOptions[key];

export const resetOptions = (): void => {
  currentOptions = { ...defaultOptions };
};

const isVimOptionKey = (prop: string): prop is keyof VimOptions => prop in defaultOptions;
